    ...
    const renderItem = ({ item }) => (
      <TouchableOpacity style={styles.box} onPress={() => handlePress(item)}>
        ...
        {item.name === 'Consulta general' && (
            <Image
                source={require('../../assets/images/ConsultaGeneral.png')}
                style={styles.image}
            />
        )}
        {item.name === 'Pediatría' && (
        ...
        {item.name === 'Ginecología' && (
            <Image
                source={require('../../assets/images/Ginecologia.png')}
                style={styles.image}
            />
        )}
        ...
        {item.name === 'Rehabilitación' && (
            <Image
                source={require('../../assets/images/Rehabilitacion.png')}
                style={styles.image}
            />
        )}
        {item.name === 'Psiquiatría' && (
            <Image
                source={require('../../assets/images/Psiquiatria.png')}
                style={styles.image}
            />
        )}
        {item.name === 'Medicina de Familia' && (
            <Image
                source={require('../../assets/images/MedicoFamilia.png')}
                style={styles.image}
            />
        )}
        {item.name === 'Enfermería' && (
            <Image
                source={require('../../assets/images/Enfermera.png')}
                style={styles.image}
            />
        )}
      </TouchableOpacity>
